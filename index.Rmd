...
DKnuts2_sf<- euro_nuts3_sf%>% filter(str_detect(NUTS_ID,"^DK"))
...
p
mapshot(p, url = file.path(getwd(),file="/denmark_stroke_nuts2_catchment.html"), file = file.path(getwd(), "/denmark_stroke_nuts2_catchment.png"))
